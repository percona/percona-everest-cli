...
echo "https://github.com/percona/percona-everest-cli/releases/download/v0.6.0/everestctl-$os-$arch"
curl -sL  https://github.com/percona/percona-everest-cli/releases/download/v0.6.0/everestctl-$os-$arch -o everestctl
chmod +x everestctl
